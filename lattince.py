...
class Lattince:
    def __init__(self, xmax, ymax, lattince_dimension, particles):
        ...
        print("init lattince")
        for i, j in  enumerate(self.particles):
            print("i particle",i, j.coords)
        print()
    ...
    def RecalculateParticle(self, particle_index):
        ...
        print("new_index", particle_index)
        print("new_index ", self.particles[particle_index])
        print("new_index ", self.particles[particle_index].coords)
        print("new_index ", self.particles[particle_index].coords[0], self.particles[particle_index].coords[1])
